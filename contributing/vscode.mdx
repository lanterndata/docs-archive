...
description: "Elevate your development experience with Visual Studio Code (VSCode) by customizing its configuration for your project. Follow our recommendations below to set up features like IntelliSense and integrate Docker containers."
---

## Recommended Extensions[](#recommended-extensions "Direct link to Recommended Extensions")
...
## Enabling IntelliSense[](#enabling-intellisense "Direct link to Enabling IntelliSense")
...
## Integrating Docker Containers[](#integrating-docker-containers "Direct link to Integrating Docker Containers")
